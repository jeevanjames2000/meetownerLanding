const ListingAds = () => {
  return (
    <>
      <div className="bg-white relative top-[105px] p-3 rounded-xl shadow-lg overflow-hidden">
        <div className="relative rounded-lg">
          ...
          <div className="absolute top-4 right-4 flex gap-4">
            <p className="bg-inherit text-[#ffffff] font-semibold px-6 py-2 rounded-lg border-1 border-[#ffffff] transition">
              View Details
            </p>
            <p className="bg-inherit text-[#ffffff] font-semibold px-6 py-2 rounded-lg border-1 border-[#ffffff] transition">
              Contact
        ...
        <div className="py-3">
          <div className="grid grid-cols-2 gap-4 mb-8">
            {[1, 2].map((i) => (
              <div key={i} className="relative rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-gray-50 rounded-b-lg overflow-hidden">
                  ...
                  <div className="p-4 text-left">
                    ...
                    <p className="text-sm text-gray-600 line-clamp-2">
                      Modern 3BHK apartment with premium amenities and lake view.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="border-t pt-6 text-left">
            <h3 className="text-lg font-semibold mb-4">More Properties By Meet Owner</h3>
            <div className="grid grid-cols-2 gap-4 mb-4">
              {[1, 2].map((i) => (
                <div key={i} className="flex gap-3">
                  <img
                    src={`https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=100&h=100&q=${i + 2}`}
                    alt={`Property ${i}`}
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Kondapur, Hyderabad</p>
                  </div>
                </div>
              ))}
            </div>
